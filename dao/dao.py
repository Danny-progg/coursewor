...
class PostsDAO:
    def __init__(self, posts_patch, comments_patch):
        self.posts_patch = posts_patch
        self.comments_path = comments_patch

    def load_posts(self):
        with open(self.posts_patch, 'r', encoding='utf-8') as file:
            new_posts = []
